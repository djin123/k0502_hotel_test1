...
public class QiniuUploadUtils {
    ...
    static String ACCESS_KEY = "g8DhcoC2DcGRnxJPuRL4aUePX8XafbV59OB2_YT9";
    static String SECRET_KEY = "BWzla7lBXmCgYFIrIJqdBdWaKyPkDTSn9HoT3OjI";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）  //http://qgbu6ffn6.hn-bkt.clouddn.com
    static String bucketname = "lqj123";
    //上传到七牛后保存的文件名  
