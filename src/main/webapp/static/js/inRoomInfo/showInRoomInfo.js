layui.use(['jquery','layer', 'table','form','laydate'], function() {
    ...
    //七牛云的存储空间的域名
    var qnyName = "http://qgbu6ffn6.hn-bkt.clouddn.com/";
    ...
    table.render({  //数据表格的数据渲染(此UI框架底层是进行异步加载)
        ...
        , url: 'inRoomInfo/loadPageTByPramas' //访问服务器端的数据接口(异步请求)，返回的json格式的数据
        , even: true  //每一行有渐变效果
        ...
        , cols: [[ //表头
            ...
            , {field: 'roomPic', title: '封面图', align: 'center', width: 120, sort: true,templet: '<div><img src="'+qnyName+'{{d.rooms.roomPic}}"></div>'}
